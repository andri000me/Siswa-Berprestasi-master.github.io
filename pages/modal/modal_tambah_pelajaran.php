                ...
                <form method="post" action="<?=BASE_URL?>/api/matpel.php?aksi=tambah" id="formTambahKelas">
                    ...
                    <div class="form-group">
                        ...
                        <select name="kelompok" class="form-control" required>
                            ...
                            <option value="BKP">Khusus BKP   </option>
                            <option value="DPIB">Khusus DPIB </option>
                            <option value="TITL">Khusus TITL </option>
                            <option value="TPTU">Khusus TPTU </option>
                            <option value="TP">Khusus TP     </option>
                            <option value="TPG">Khusus TPG   </option>
                            <option value="TKR">Khusus TKR   </option>
                            <option value="TSM">Khusus TSM   </option>
                            <option value="TAV">Khusus TAV   </option>
                            <option value="TKJ">Khusus TKJ   </option>
                            <option value="RPL">Khusus RPL   </option>
