                ...
                <form method="post" action="" id="formUpdateSiswa">
                    ...
                    <div class="form-group">
                        ...
                        <select name="jurusan" required>
                            <option value="BKP" <?=$row['jurusan']=='BKP'?'required':''?>>BKP</option>
                            <option value="DPIB" <?=$row['jurusan']=='DPIB'?'required':''?>>DPIB</option>
                            <option value="TG" <?=$row['jurusan']=='TG'?'required':''?>>TG</option>
                            <option value="TITL" <?=$row['jurusan']=='TITL'?'required':''?>>TITL</option>
                            <option value="TPTU" <?=$row['jurusan']=='TPTU'?'required':''?>>TPTU</option>
                            <option value="TP" <?=$row['jurusan']=='TP'?'required':''?>>TP</option>
                            <option value="TPG" <?=$row['jurusan']=='TPG'?'required':''?>>TPG</option>
                            <option value="TKR" <?=$row['jurusan']=='TKR'?'required':''?>>TKR</option>
                            <option value="TSM" <?=$row['jurusan']=='TSM'?'required':''?>>TSM</option>
                            <option value="TAV" <?=$row['jurusan']=='TAV'?'required':''?>>TAV</option>
                            <option value="TKJ" <?=$row['jurusan']=='TKJ'?'required':''?>>TKJ</option>
                            <option value="RPL" <?=$row['jurusan']=='RPL'?'required':''?>>RPL</option>
