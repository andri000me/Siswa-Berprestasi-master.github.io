        ...
        if($ss) {
            ...
            for($i=0;$i<count($ss);$i++) {
                ...
                if(mysqli_num_rows($cek)>0) {
                    ...
                    $query = "INSERT INTO tbl_kehadiran (jml_sakit, jml_izin,jml_alpha, jml_hadir, jml_pertemuan, jml_tidak_hadir, persentase,id_siswa, id_ajaran) 
                         values('$sakit[$i]','$izin[$i]','$alpa[$i]','$hadir','50','$jml','$persen','$ss[$i]','$_GET[ajaran]')";
                }
