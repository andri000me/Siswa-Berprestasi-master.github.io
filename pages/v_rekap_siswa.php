                                ...
                                <tr>
                                    ...
                                    <?php 
                                        $kepribadian = mysqli_fetch_assoc(mysqli_query($db,"select * from tbl_subkriteria where id_subkriteria='$row[kepribadian]'"));
                                         $nonakademik = mysqli_fetch_assoc(mysqli_query($db,"select * from tbl_subkriteria where id_subkriteria='$row[nonakademik]'"));
                                          $eskul = mysqli_fetch_assoc(mysqli_query($db,"select * from tbl_subkriteria where id_subkriteria='$row[eskul]'"));
                                    ...
                                    <td><?=$nonakademik['nama_subkriteria']?$nonakademik['nama_subkriteria']:'Belum Input'?> </td>
                                    <td><?=$eskul['nama_subkriteria']?$eskul['nama_subkriteria']:'Belum Input'?> </td>
